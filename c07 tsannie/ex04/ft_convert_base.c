...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/09 07:58:23 by tsannie           #+#    #+#             */
/*   Updated: 2020/07/09 07:58:26 by tsannie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_premier_base(char *base_to)
{
	char *conv;

	if (!(conv = malloc(sizeof(char) * 2)))
		return (NULL);
	conv[0] = base_to[0];
	conv[1] = '\0';
	return (conv);
